...
def home():
    # Serve the new index.html from the frontend directory
...
def admin_page():
    # Serve admin.html from frontend directory
...
def guard_page():
    # Serve guard.html from frontend directory
    guard_path = os.path.join(FRONTEND_DIR, "guard.html")
    if os.path.exists(guard_path):
        with open(guard_path, encoding="utf-8") as f:
            return f.read()
    return "<h1>Guard page not found</h1>"
